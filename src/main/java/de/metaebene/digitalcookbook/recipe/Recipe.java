...
public class Recipe {
    ...
    public Recipe(int recipePortions, String recipeTitle, String recipeDescription, String recipeWorktime, String recipeCooktime, RecipeType recipeType, Image recipeImage) {
        this.recipeID = -1;
        this.recipePortions = recipePortions;
        this.recipeTitle = recipeTitle;
        this.recipeDescription = recipeDescription;
    ...
    public HashMap<Ingredient, Double> getRecipeIngredientHashmap() {
        return recipeIngredientHashmap;
    }
